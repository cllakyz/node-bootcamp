...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // Create Popup

    var popup = new mapboxgl.Popup({
      offset: 30
    }).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")); // Add marker

    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).setPopup(popup).addTo(map); // Extend map bounds to include current location
...
var stripe = Stripe('pk_test_51H1duzGMH5QFtROY82mUUbT1xMcPPS4LBxM7pZh64kFQN1emOnXOq1hwpYvTWo6iySNijXJo1GNv5VmHpaJpeddP00yZ3ctMHi');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(sessionData); // 2) Create checkout form + chanre credit card
